...
from .views import AcademyDetailView, AcademyCreateView, SkillsCreateView, HistoryCreateView, ProjectCreateView, AcademyCreateView, StackCreateView, FactsCreateView
